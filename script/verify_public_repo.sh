...
section "Alpha first tester flow"
./script/alpha_first_tester.sh --self-test
...
require_phrase README.md 'docs/release/signing-notarization-setup\.md'
...
require_phrase docs/alpha/alpha-ops-checklist.md './script/alpha\.sh health'
require_phrase docs/alpha/private-alpha-workflow.md '--dry-run'
require_phrase docs/alpha/private-alpha-workflow.md './script/alpha\.sh health'
...
require_phrase docs/mvp/alpha-install-guide.md './script/alpha\.sh health'
...
require_phrase .github/ISSUE_TEMPLATE/alpha_feedback.md 'Display setup: built_in / external / multiple / clamshell / unknown'
...
require_phrase .github/ISSUE_TEMPLATE/bug_report.md 'Display setup: built_in / external / multiple / clamshell / unknown'
...
require_phrase docs/release/private-beta-packaging-checklist.md 'signing-notarization-setup\.md'
require_phrase docs/release/release-strategy.md 'signing-notarization-setup\.md'
require_phrase docs/release/signing-notarization-setup.md './script/alpha\.sh signing --require-ready'
require_phrase docs/release/signing-notarization-setup.md './script/alpha\.sh beta-ready --require-ready'
require_phrase docs/release/signing-notarization-setup.md './script/alpha\.sh package --signed'
require_phrase docs/release/signing-notarization-setup.md 'Do not commit'
require_phrase docs/release/signing-notarization-setup.md 'Do not publish a public installer'
...
require_phrase docs/alpha/first-tester-operator-checklist.md './script/alpha\.sh health'
...
require_phrase docs/alpha/improvement-backlog.md '9 focused calculator cases'
require_phrase script/alpha_first_tester.sh './script/alpha\.sh health'
require_phrase script/generate_alpha_invite.sh './script/alpha\.sh health'
require_phrase script/approve_alpha_tester.sh './script/alpha\.sh health'
require_phrase script/prepare_alpha_tracker.sh './script/alpha\.sh health'
require_phrase script/start_alpha.sh './script/alpha\.sh health'
