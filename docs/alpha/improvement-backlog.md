...
- Add visual style presets: compact pill, full MRR panel, goal panel, and ultra-minimal number-only style. Done: setup exposes full, compact, number-only, and goal styles.
